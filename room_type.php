                    ...
                    <div class="card-body">
                        <div class="form-group row">
                          <form method="POST" action="search.php">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="search"><input type="submit" style="visibility: hidden;" />
                            </div>
                          </form>
                        </div>
                        <div class="row">
                            ...
                            <main role="main" class="col-lg-9">
                                ...
                                <?php 
                                 $id = $auth->getUserId();
                                $sql = "SELECT * FROM form_submission Where user_id = '".$id."' ORDER BY room_type ASC";
